...
@interface MASpringBoardLayout : UICollectionViewFlowLayout<UIGestureRecognizerDelegate>
...
@protocol MASpringCollectionViewDataSource <UICollectionViewDataSource>
...
@protocol MASpringCollectionViewDelegateFlowLayout <UICollectionViewDelegateFlowLayout>
@optional
